...
// MÓDULO INDUSTRIALIZAÇÃO
    ...
    else if (value == 'produtos' || value == 'grupo produtos' || value == 'etapas producao' || value == 'tipos produtos' || value == 'linha producao' || value == 'linhas producao' || value == 'composicao' || value == 'familia produto'){
